...
- **Todo funciona sin API**: cada función con IA (redactar clase, editar entrada del historial, planificación anual, día a día y edición del CSV en Exportar) tiene su botón "Prompt para IA externa" que arma el mismo prompt que usaría la API, lo copiás en cualquier chat de IA, y la respuesta la pegás donde la app te indica.
